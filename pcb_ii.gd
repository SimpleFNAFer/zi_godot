...
var component = preload("res://PCB.tscn")
...
func _on_button_mouse_entered() -> void:
	if desc_instance == null:
		...
		desc_instance.name = "PCBDescription"
		desc_instance.get_node("RichTextLabel").text = "Программируемый логический контроллер"
...
func _on_button_mouse_exited() -> void:
	$/root/Root/PCBDescription.queue_free()
	desc_instance = null
