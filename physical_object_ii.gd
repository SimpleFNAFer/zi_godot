...
var component = preload("res://PhysicalObject.tscn")
...
func _on_button_mouse_entered() -> void:
	if desc_instance == null:
		...
		desc_instance.name = "PhysicalObjectDescription"
		desc_instance.get_node("RichTextLabel").text = "Сенсоры на оборудовании, которые собирают параметры в реальном времени. Расположены на оборудовании"
...
func _on_button_mouse_exited() -> void:
	$/root/Root/PhysicalObjectDescription.queue_free()
	desc_instance = null
